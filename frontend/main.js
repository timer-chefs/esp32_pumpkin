import { switchToMicrophone, stopMicrophone } from "./microphone_controller.js";
...
import { playShow } from "./show_controller.js";

import { presetShows } from "./preset_shows.js";

import { handleSelectAudioFolder } from "./folder_manager.js";
...
document.getElementById("btn-file").addEventListener("click", switchToFile);
document
...
document.getElementById("btn-stop-file").addEventListener("click", stopAudio);
document
