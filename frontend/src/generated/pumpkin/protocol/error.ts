...
import { ErrorCode } from '../../pumpkin/protocol/error-code.js';
...
code():ErrorCode {
  ...
  return offset ? this.bb!.readUint8(this.bb_pos + offset) : ErrorCode.UNKNOWN;
}
...
static addCode(builder:flatbuffers.Builder, code:ErrorCode) {
  builder.addFieldInt8(0, code, ErrorCode.UNKNOWN);
}
