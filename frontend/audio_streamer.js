import { audioState } from "./audio_state.js";
...
import { setFileStatus } from "./audio_ui.js";

import { sendCommand } from "./command_sender.js";

import { processAudioFile } from "./audio_file_processor.js";
  ...
  return new Promise((resolve, reject) => {
    ...
    audioState.socket.onopen = () => {
      ...
      const streamChunk = () => {
        if (
          offset < data.length &&
          isSocketOpen(audioState.socket) &&
          ...
          console.log(
            `✓ Streaming complete! ${bytesSent} bytes in ${elapsed}s`,
          );
          setFileStatus(
